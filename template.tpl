...
{
  "displayName": "LinkedIn Event Tracking",
  "categories": ["SOCIAL","CONVERSIONS","ADVERTISING"],
  "description": "Easily deploy a LinkedIn event pixel to track conversions.",
  "securityGroups": [],
  ...
  "brand": {
    ...
    "displayName": "LinkedIn Event Tracking (Unofficial)",
    "id": "brand_dummy"
  },
  "containerContexts": [
    "WEB"
...
[
  ...
  {
    "help": "The Conversion ID of your Event.",
    "alwaysInSummary": true,
    "valueValidators": [
      {
        "type": "NON_EMPTY"
...
/* GTMTEMPLATESCOM_CHECKSUM:[5706275094528000,1560849362021,420fc3f44ff191763eadd7ec28c6c7b2] */
